...
const volumeBlock = document.querySelector('.volume-controls');
...
// CHECK SUPPORT & HIDE DEFAULT CONTROLS
...
// PLAY
// togglePlay toggles the playback state of the video. If the video playback is paused or ended, the video is played otherwise, the video is paused
function togglePlay() {
...
// toggleMute mutes or unmutes the video when executed When the video is unmuted, the volume is returned to the value it was set to before the video was muted
function toggleMute() {
...
volumeBlock.addEventListener('pointerover', showVolume);
volumeBlock.addEventListener('pointerout', hideVolume)
